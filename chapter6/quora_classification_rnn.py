...
from keras.layers import SpatialDropout1D, add, concatenate, SimpleRNN
...
def build_model_rnn(size):
    ...
    rnn_layer = SimpleRNN(128, return_sequences=True)(embedding_layer)
    dense_layer = Flatten()(rnn_layer)
